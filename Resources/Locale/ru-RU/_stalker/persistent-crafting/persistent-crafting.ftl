...
persistent-craft-window-loading-points = Очки тиров загружаются...
persistent-craft-points = Очки тиров: {$points}
...
persistent-craft-popup-not-enough-points = Недостаточно очков этого тира.
...
persistent-craft-popup-tier-auto = Главный тир и стартовый подуровень .1 открываются автоматически от уровня ветки.
