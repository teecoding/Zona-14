...
ent-ClothingOuterArmorBerill5MMonolith = бронекостюм «Берилл-5М» монолита
    .desc = Бронекостюм, пренадлежащий группировке фанатиков. Обеспечивает отличную защиту по всем показателям, но делает из вас живую мишень.
ent-STClothingOuterArmorLepestokNeutral = бронекомбез "Лепесток Берилла" нейтралов
    .desc = Доработанный умельцем из Нейтралов "Синицей". С улучшенной тканью.
