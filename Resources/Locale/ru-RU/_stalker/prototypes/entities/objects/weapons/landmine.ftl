ent-LandMineExplosiveStalker = мина ПФМ-1 "Лепесток"
    .desc = Одна нога здесь, другая там.
    .suffix = Stalker
ent-LandMineExplosiveStalkerCompact = неустановленная мина ПФМ-1 "Лепесток"
