...
job-military-rules = Рядовые обязаны слушаться офицеров. Офицеры обязаны слушаться начальника гарнизона. Военные могут стопать сталкеров для выяснения причин проникновения в ЧЗО. Запрещена стрельба в сталкеров первыми. Запрещено изымать что-либо у сталкеров, кроме предметов первой необходимости, если у вас их нет (еда, медикаменты). После того как сталкер как-либо платит штраф, даёт взятку - вы обязаны его отпустить. Не душить. Если видно, что человек не хочет отыгрывать - быстро его обрабатывайте и отпускайте. Никаких пленов без причины. Не нужно душить сталкеров, по пол часа держа в обоссаном подвале или посреди поля ради "весёлых" конкурсов.
