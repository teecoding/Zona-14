...
public sealed class GibMistParticleSystem : EntitySystem
{
    ...
    {
        base.Initialize();
        //SubscribeLocalEvent<BloodstreamComponent, BeingGibbedEvent>(OnBeingGibbed); // EN - should work but theres dupe subscriptions and it doesnt look so great anyways
    }

    private void OnBeingGibbed(Entity<BloodstreamComponent> ent, ref BeingGibbedEvent args)
    {
        var color = Color.Red;
        var contents = ent.Comp.BloodReagents.Contents;
