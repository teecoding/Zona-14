...
// Ported from RMC-14 Content.Shared/_RMC14/Movement/SharedRMCLagCompensationSystem.cs@4283bf50a3.
...
public abstract class SharedRMCLagCompensationSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_config, Zona14CVars.LagCompensationMarginTiles, v => MarginTiles = v, true);
    }
    ...
    public bool IsWithinMargin(Entity<TransformComponent?> sessionEnt, Entity<TransformComponent?> lagCompensatedTarget,
        ICommonSession? session, float range)
    {
    ...
    public bool Collides(Entity<FixturesComponent?> target, Entity<PhysicsComponent?> projectile,
        MapCoordinates targetCoordinates)
    {
        ...
        return (closest - projectilePosition).LengthSquared() <= MarginTiles * MarginTiles;
    }
