...
using Content.Client._Stalker_EN.News;
...
/// Implements <see cref="INewsLinkClickHandler"/> to handle news link clicks from message entries.
/// </summary>
[GenerateTypedNameReferences]
public sealed partial class STMessengerChannelPage : BoxContainer, IOfferLinkClickHandler, INewsLinkClickHandler
{
    ...
    /// <summary>Raised when the user clicks a news link in a message.</summary>
    public event Action<int>? OnNewsLinkClicked;
    ...
    {
        OnNewsLinkClicked?.Invoke(articleId);
    }
}
